...
export class Filter implements IFilter {
    ...
    init(_data?: any) {
        if (_data) {
            this.modelFilter = _data["modelFilter"] ? ModelFilter.fromJS(_data["modelFilter"]) : <any>undefined;
            this.isOrClause = _data["isOrClause"];
            this.keyGroup = _data["keyGroup"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["modelFilter"] = this.modelFilter ? this.modelFilter.toJSON() : <any>undefined;
        data["isOrClause"] = this.isOrClause;
...
export class ModelFilter implements IModelFilter {
    fieldName: string | undefined;
    fieldValue: string | undefined;
    matchMode: string | undefined;

    constructor(data?: IModelFilter) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ModelFilter {
        data = typeof data === 'object' ? data : {};
        let result = new ModelFilter();
        result.init(data);
        return result;
    }
...
export class TableColumn implements ITableColumn {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.typeConvertKeyword = _data["typeConvertKeyword"];
    ...
    toJSON(data?: any) {
        ...
        data["typeConvertKeyword"] = this.typeConvertKeyword;
